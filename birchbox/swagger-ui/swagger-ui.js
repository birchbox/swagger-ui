...
(function() {
  ...
  HeaderView = (function(_super) {
    ...
    HeaderView.prototype.events = {
      ...
      'click #authentication': 'showCustomAuthentication',
      'click #product': 'showCustomProduct',
      'click #user': 'showCustomUser',
    ...
    HeaderView.prototype.showCustomAuthentication = function(e) {
      if (e != null) {
        e.preventDefault();
      }
      return this.trigger('update-swagger-ui', {
        url: $('#input_baseUrl1').val() + "/authentication/api-docs.json",
        apiKey: $('#input_apiKey').val()
      });
    };

    HeaderView.prototype.showCustomProduct = function(e) {
      if (e != null) {
        e.preventDefault();
      }
      return this.trigger('update-swagger-ui', {
        url: $('#input_baseUrl1').val() + "/products/api-docs.json",
        apiKey: $('#input_apiKey').val()
      });
    };

    HeaderView.prototype.showCustomUser = function(e) {
      if (e != null) {
        e.preventDefault();
      }
      return this.trigger('update-swagger-ui', {
        url: $('#input_baseUrl1').val() + "/users/api-docs.json",
        apiKey: $('#input_apiKey').val()
      });
    };

    HeaderView.prototype.showCustomFeed = function(e) {
      if (e != null) {
        e.preventDefault();
      }
      return this.trigger('update-swagger-ui', {
        url: $('#input_baseUrl1').val() + "/feed/api-docs.json",
        apiKey: $('#input_apiKey').val()
      });
    };

    HeaderView.prototype.showCustomContent = function(e) {
      if (e != null) {
        e.preventDefault();
      }
      return this.trigger('update-swagger-ui', {
        url: $('#input_baseUrl1').val() + "/content/api-docs.json",
        apiKey: $('#input_apiKey').val()
      });
    };

    HeaderView.prototype.showCustomShop = function(e) {
      if (e != null) {
        e.preventDefault();
      }
      return this.trigger('update-swagger-ui', {
